 ...
 * @since 1.0.0
 */
class harmonia_Walker_Mega_Menu extends Walker_Nav_Menu {
	/**
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if ( ! $depth && $this->in_mega ) {
			...
			$output .= "\n$indent<div class=\"grid-container2\">\n<ul class=\"mega-menu-columns\">\n";
		}
	}
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( in_array( 'hot', $classes )  ) {
			$item_output .= '<span class="hot-menu">' . esc_html__( 'Hot', 'harmonia' ) . '</span>';
		} elseif ( in_array( 'new', $classes ) ) {
			$item_output .= '<span class="new-menu">' . esc_html__( 'New', 'harmonia' ) . '</span>';
		}
