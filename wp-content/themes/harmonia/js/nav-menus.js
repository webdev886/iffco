...
(function ($) {
	...
	$(function () {
		...
		$( '#menu-to-edit li.menu-item' ).each(function () {
			$(this).find('.item-title').append('<span class="lp-mega-menu">' + harmonia.megamenu + '</span>');
		});
		...
		$( '#menu-to-edit li.menu-item' ).on( 'click', '.lp-mega-menu', function( e ) {
			...
			$.ajax( {
				...
				url: ajaxurl,
				data: {
					action: 'harmonia_mega_fields',
					lpnonce: harmonia.nonce,
					menu_id: menuId,
				...
				success: function( response ) {
					$modal.html(
						...
						'<div class="modal-footer"><a href="#" id="modal-save-menu-header" class="button button-primary menu-save">' + harmonia.savemenu + '</a><span class="refresh" style="display: none"> <i class="fa fa-refresh"></i></span></div>' +
						'</div>' +
						'</div>' +
						'</div>');
