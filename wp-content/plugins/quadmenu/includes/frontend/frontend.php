...
class QuadMenu_Frontend {
  ...
  public function register() {
    ...
    wp_register_style('quadmenu-normalize', QUADMENU_PLUGIN_URL . 'assets/frontend/css/quadmenu-normalize' . QuadMenu::isMin() . '.css', array(), QUADMENU_PLUGIN_VERSION, 'all');

    wp_register_script('quadmenu', QUADMENU_PLUGIN_URL . 'assets/frontend/js/quadmenu' . QuadMenu::isMin() . '.js', array('hoverIntent'), QUADMENU_PLUGIN_VERSION, true);

    wp_register_style('quadmenu', QUADMENU_PLUGIN_URL . 'assets/frontend/css/quadmenu' . QuadMenu::isMin() . '.css', array(), QUADMENU_PLUGIN_VERSION, 'all');
