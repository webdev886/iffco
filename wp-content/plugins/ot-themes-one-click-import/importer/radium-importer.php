    ...
    public function demo_installer() {
        ...
        <form method="post">
            ...
            <select name="ot_demo_file" style="width: 100px;">
				...
				<option value="default">Default Version</option> <!-- Davis change -->
				<option value="agency">Agency Version</option> <!-- Davis change --> 
				<option value="barber-shop">Barber-shop version</option> <!-- Davis change --> 
				<option value="club">Club version</option> <!-- Davis change --> 				
				<option value="construction">Construction version</option> <!-- Davis change --> 
				<option value="corporate">Corporate version</option> <!-- Davis change --> 
				<option value="cosmetics">Cosmetics version</option> <!-- Davis change --> 
				<option value="creative">Creative version</option> <!-- Davis change --> 
				<option value="farmer">Farmer version</option> <!-- Davis change --> 
				<option value="fitness">Fitness version</option> <!-- Davis change --> 
				<option value="landing">Landing version</option> <!-- Davis change -->
				<option value="masonry">Masonry version</option> <!-- Davis change --> 
				<option value="medical">Medical version</option> <!-- Davis change --> 
				<option value="onepage">Onepage version</option> <!-- Davis change -->
				<option value="portfolio">Portfolio version</option> <!-- Davis change -->
				<option value="profile">Profile version</option> <!-- Davis change --> 
				<option value="photographer">Photographer version</option> <!-- Davis change --> 				
				<option value="restaurant">Restaurant version</option> <!-- Davis change --> 
				<option value="software">Software version</option> <!-- Davis change --> 
				<option value="story">Story version</option> <!-- Davis change -->
				<option value="tourist">Tourist version</option> <!-- Davis change --> 
				<option value="video-slider">Video-slider version</option> <!-- Davis change --> 
				<option value="vintage">Vintage version</option> <!-- Davis change -->
				<option value="wedding">Wedding version</option> <!-- Davis change --> 
            </select>
            <br/><br/>
